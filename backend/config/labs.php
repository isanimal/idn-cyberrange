...
return [
    ...
    'public_host' => env('CYBERRANGE_PUBLIC_HOST'),
    'public_scheme' => env('CYBERRANGE_PUBLIC_SCHEME', 'http'),
    'public_port_mode' => env('CYBERRANGE_PUBLIC_PORT_MODE', 'direct'),
    'public_base_url' => env('CYBERRANGE_PUBLIC_BASE_URL'),
    'allowed_port_range' => env('CYBERRANGE_ALLOWED_PORT_RANGE'),
    'public_proxy_path_prefix' => env('CYBERRANGE_PUBLIC_PROXY_PATH_PREFIX', '/lab'),
    'runtime_root' => env('DOCKER_LAB_RUNTIME_ROOT', '/var/lib/idn-cyberrange/instances'),
    'port_start' => (int) env('PORT_RANGE_START', env('DOCKER_LAB_PORT_RANGE_START', 20000)),
    'port_end' => (int) env('PORT_RANGE_END', env('DOCKER_LAB_PORT_RANGE_END', 40000)),
    'start_lock_seconds' => (int) env('LAB_START_LOCK_SECONDS', 60),
